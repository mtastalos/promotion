-- =============================================================================
-- Automated Social Media Posting System — PostgreSQL Schema
-- =============================================================================
...
-- ── USERS ─────────────────────────────────────────────────────────────────────
-- Top-level authentication entity. Owns all user-scoped data.
...
-- ── PROFILES ──────────────────────────────────────────────────────────────────
-- A named persona (brand or account group) owned by a user.
...
-- ── SOCIAL ACCOUNTS ───────────────────────────────────────────────────────────
-- Connected OAuth accounts. A profile can have multiple accounts per platform.
...
-- ── AI CONFIGURATIONS ─────────────────────────────────────────────────────────
-- One-per-profile AI provider settings.
...
-- ── MEDIA ─────────────────────────────────────────────────────────────────────
-- Asset records owned at user level, reusable across profiles and posts.
...
-- ── POSTS ─────────────────────────────────────────────────────────────────────
-- Canonical post record. Self-references for reposts.
...
-- ── POST MEDIA ────────────────────────────────────────────────────────────────
-- Junction table linking posts to media assets with display ordering.
...
-- ── PLATFORM POST INSTANCES ───────────────────────────────────────────────────
-- One row per (post × social_account) pair; tracks dispatch outcome.
...
-- ── POST ANALYTICS ────────────────────────────────────────────────────────────
-- One-to-one with platform_post_instance. Stores latest engagement counters.
...
-- ── AI GENERATIONS ────────────────────────────────────────────────────────────
-- Audit log of every AI call: prompt, model, tokens, output, latency.
...
-- ── POST QUEUE ────────────────────────────────────────────────────────────────
-- Background job queue for scheduling post dispatch with retry tracking.
...
-- Partial index: only index rows the worker will actually touch
